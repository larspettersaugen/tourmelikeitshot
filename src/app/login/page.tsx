        ...
        {hasGoogle && (
          <>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-stage-border bg-white hover:bg-zinc-100 text-zinc-800 font-medium disabled:opacity-50"
            >
